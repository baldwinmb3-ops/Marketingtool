...
const { nowIso, normalizeEmail, normalizeManagerTitle, normalizeRole, normalizeStatus, normalizeWwid } = require('./lib.cjs');
...
function mapUserRowToBackup(row) {
  ...
  return {
    ...
    phone: String(src.phone || src.phoneNumber || '').trim(),
    ...
    managerTitle: normalizeManagerTitle(src.manager_title ?? src.managerTitle, ''),
